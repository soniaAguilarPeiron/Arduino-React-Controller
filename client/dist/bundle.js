...
*/
var aa=__webpack_require__(0),n=__webpack_require__(1),q=__webpack_require__(5);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
...
function () {
  ...
  _createClass(Connection, [{
    ...
    value: function addOnMessageCallback() {
    ...
    key: "addMsgListener",
    value: function addMsgListener(msgCode, callback) {
      ...
      if (typeof msgCode !== 'string') {
        console.error("The event name must be a string, the given type is ".concat(typeof event === "undefined" ? "undefined" : _typeof(event)));
        return false;
    ...
    value: function removeMsgListener(msgCode, callback) {
      ...
      this.events[msgCode].listeners = this.events[msgCode].listeners.filter(function (listener) {
        return listener.toString() !== callback.toString();
      });
    }
  }, {
    key: "dispatch",
    value: function dispatch(msgCode, details) {
      // Check if this event not exists
      console.log('dispatching event:' + msgCode);

      if (this.events[msgCode] === undefined) {
        console.error("This event: ".concat(msgCode, " does not exist"));
        return false;
      }

      this.events[msgCode].listeners.forEach(function (listenerCallback) {
...
var src_ArduinoController =
/*#__PURE__*/
function (_React$Component) {
  _inherits(ArduinoController, _React$Component);

  function ArduinoController(props) {
    var _this;

    src_classCallCheck(this, ArduinoController);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ArduinoController).call(this, props));
    _this._isMounted = false; // needed
  ...
  src_createClass(ArduinoController, [{
    ...
    value: function connect() {
      var ws = new Connection(this.props.ipServer);
    ...
    key: "turnOn",
    value: function turnOn(from) {
      this._isMounted && this.setState(function (state) {
        return {
          currentState: true
        };
      });
...
react_dom_default.a.render(react_default.a.createElement(src_ArduinoController, {
  ipServer: "ws://192.168.1.29:8090/"
